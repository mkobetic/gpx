...
func Test_AnalyzeTurn1(t *testing.T) {
	...
	assertEqual(t, len(trk.Segments[0].Points), 3)
	assertEqual(t, trk.Segments[1].Mode, Turning)
	assertEqual(t, len(trk.Segments[1].Points), 12)
	assertEqual(t, trk.Segments[2].Mode, Moving)
	assertEqual(t, len(trk.Segments[2].Points), 8)
...
func Test_AnalyzeTurn2(t *testing.T) {
	...
	assertEqual(t, trk.Segments[1].Mode, Static)
	assertEqual(t, len(trk.Segments[1].Points), 4)
	assertEqual(t, trk.Segments[2].Mode, Moving)
	assertEqual(t, len(trk.Segments[2].Points), 7)
...
func Test_AnalyzeTurn3(t *testing.T) {
	...
	trk.gpxAnalyze(Sailing)
	assertEqual(t, len(trk.Segments), 4)
	assertEqual(t, trk.Segments[0].Mode, Moving)
	assertEqual(t, len(trk.Segments[0].Points), 5)
	assertEqual(t, trk.Segments[1].Mode, Turning)
	assertEqual(t, len(trk.Segments[1].Points), 7)
	assertEqual(t, trk.Segments[2].Mode, Static)
	assertEqual(t, len(trk.Segments[2].Points), 2)
	assertEqual(t, trk.Segments[3].Mode, Moving)
	assertEqual(t, len(trk.Segments[3].Points), 9)
	assertEqual(t, trk.FileName(), "240824-0h01-00.1nm")
	// logTrackPoints(t, trk)
}
